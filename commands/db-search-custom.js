...
//TODO: Sends connect request even though it's already logged in.
//TODO: loses connection quickly. Maybe need to send pings to stay alive.
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // const msg = await interaction.editReply({content:"React.", fetchReply: true});
        // await msg.react("✅");
        ...
        // }).catch(async (collected) => { //when time is up
        //     console.log("time is up");
        // });

        //TODO: Only get reaction when I delete the message? Also doesn't stop after the set time?
